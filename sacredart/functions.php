...
function underscores_scripts() {
	wp_enqueue_style( 'underscores-style', get_stylesheet_uri() );
                ...
                wp_enqueue_style( 'underscores-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css' );
	wp_enqueue_style( 'underscores-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css' );

                 wp_enqueue_style( 'underscores-style-original', get_template_directory_uri() . '/css/styles.css' );
                wp_enqueue_style( 'underscores-stylish-portfolio', get_template_directory_uri() . '/css/stylish-portfolio.css' );
                
                wp_enqueue_style('underscores-fonts', 'https://fonts.googleapis.com/css?family=Cinzel:400,700|Fira+Sans:400,400i,700,700i" rel="stylesheet');
...
wp_enqueue_script( 'popperscores-navigation', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20151215', true );
	...
	wp_enqueue_style( 'underscores-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
        //wp_enqueue_script('underscores-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css');
